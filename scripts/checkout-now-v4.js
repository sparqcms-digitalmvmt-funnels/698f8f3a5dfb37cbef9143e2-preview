...
function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/698f8f3a5dfb37cbef9143e2-preview") ? value : (value.startsWith("/") ? "/698f8f3a5dfb37cbef9143e2-preview" + value : "/698f8f3a5dfb37cbef9143e2-preview/" + value);
  };
...
const getVrioCampaignInfoBasedOnPaymentMethod = (isVipUpsell) => {
    const vrioCampaigns = [{"_id":"698f8e945dfb37cbef914349","integration":[{"_id":"68de8b4ba7998abc5f77b02a","workspace":"develop","platform":"vrio","description":"production","fields":{"publicApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg","internalApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg"},"status":"active","createdAt":1758437407128,"updatedAt":1759415115447,"__v":0,"category":"CRM","id":"68de8b4ba7998abc5f77b02a"}],"externalId":"253","name":"Akemi Slim Patch - Network - (1)","currency":"USD","countries":[223,38],"metadata":{"campaign_id":253,"campaign_name":"","payment_type_id":1,"campaign_active":true,"campaign_prepaid":true,"campaign_payment_method_required":true,"campaign_group_transactions":true,"campaign_global_js":"","campaign_global_seo_title":"","campaign_global_seo_keywords":"","campaign_global_seo_description":"","date_created":"2026-02-13 20:50:29","created_by":0,"date_modified":"2026-02-13 20:50:29","modified_by":0,"campaign_notes":"","offers":[],"shipping_profiles":[],"campaignId":"253","externalId":253,"description":"","payment_methods":["amex","discover","visa","master"],"alternative_payments":[],"countries":[{"iso_numeric":840,"calling_code":"1","id":223,"name":"United States of America","iso_2":"US","iso_3":"USA"},{"iso_numeric":124,"calling_code":"1","id":38,"name":"Canada","iso_2":"CA","iso_3":"CAN"}]},"funnels":[],"createdAt":1770900450405,"updatedAt":1771015829002,"packages":[],"status":"active","platform":"vrio","__v":0,"id":"698f8e945dfb37cbef914349"}];
...
const DEFAULT_OFFER_ID = '252';
const getVrioOfferInfoByProductId = (productId) =>
  ((productId) => {
    const vrioOffers = [{"id":252,"offerTypeId":1,"name":"Akemi Slim Patch - Network","items":[{"name":"1 Month Supply (30 Patches) - Slim Patch","id":1755,"quantity":1,"price":0,"shippable":false},{"name":"1x Akemi Detox Tea","id":1699,"quantity":1,"price":0,"shippable":false},{"name":"1x Pack (30 Patches) -  Slim Patch","id":1751,"quantity":1,"price":0,"shippable":false},{"name":"2 Month Supply (60 Patches) -  Slim Patch","id":1756,"quantity":1,"price":0,"shippable":false},{"name":"2x Akemi Detox Tea","id":1700,"quantity":1,"price":0,"shippable":false},{"name":"2x Packs (60 Patches) -Slim Patch","id":1752,"quantity":1,"price":0,"shippable":false},{"name":"3 Month Supply (90 Patches) -  Slim Patch","id":1757,"quantity":1,"price":0,"shippable":false},{"name":"3x Akemi Detox Tea","id":1701,"quantity":1,"price":0,"shippable":false},{"name":"3x Packs (90 Patches) -  Slim Patch","id":1753,"quantity":1,"price":0,"shippable":false},{"name":"4 Month Supply (120 Patches) -  Slim Patch","id":1758,"quantity":1,"price":0,"shippable":false},{"name":"4x Akemi Detox Tea","id":1763,"quantity":1,"price":0,"shippable":false},{"name":"4x Packs (120 Patches) - Slim Patch","id":1754,"quantity":1,"price":0,"shippable":false},{"name":"Akemi Detox Tea","id":1698,"quantity":1,"price":0,"shippable":true},{"name":"Akemi Slim Patch  Journey Package Protection","id":1760,"quantity":1,"price":0,"shippable":false},{"name":"Akemi Slim Patch - 3 Year Warranty","id":1759,"quantity":1,"price":0,"shippable":false},{"name":"Slim Patch","id":1750,"quantity":1,"price":0,"shippable":true},{"name":"Special 1x EXTRA 1 Month Supply (30 Patches) - Slim Patch","id":1761,"quantity":1,"price":0,"shippable":false}]},{"id":253,"offerTypeId":2,"name":"Akemi Slim Patch - VIP","items":[{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":14.99,"shippable":false}]},{"id":"282","offerTypeId":2,"name":"Akemi Slim Patch - every month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":14.99,"shippable":true}],"description":""},{"id":"281","offerTypeId":2,"name":"Akemi Slim Patch - every month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":17.99,"shippable":true}],"description":""},{"id":"280","offerTypeId":2,"name":"Akemi Slim Patch - every month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":24.99,"shippable":true}],"description":""},{"id":"261","offerTypeId":2,"name":"Akemi Slim Patch - 4 month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":14.99,"shippable":true}],"description":""},{"id":"260","offerTypeId":2,"name":"Akemi Slim Patch - 3 month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":17.99,"shippable":true}],"description":""},{"id":"259","offerTypeId":2,"name":"Akemi Slim Patch - 2 month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":24.99,"shippable":true}],"description":""},{"id":"258","offerTypeId":2,"name":"Akemi Slim Patch - 1 month subscription","items":[{"id":1750,"name":"Slim Patch","quantity":1,"price":29.99,"shippable":true}],"description":""}];
...
const getPrices = () => {
  return [{"name":"1 Month Supply (30 Patches) - Slim Patch","id":1755,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1 Month Supply (30 Patches) - Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"1x Akemi Detox Tea","id":1699,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"name":"1x Pack (30 Patches) -  Slim Patch","id":1751,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x Pack (30 Patches) -  Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"2 Month Supply (60 Patches) -  Slim Patch","id":1756,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2 Month Supply (60 Patches) -  Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"2x Akemi Detox Tea","id":1700,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"name":"2x Packs (60 Patches) -Slim Patch","id":1752,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Packs (60 Patches) -Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"3 Month Supply (90 Patches) -  Slim Patch","id":1757,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3 Month Supply (90 Patches) -  Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"3x Akemi Detox Tea","id":1701,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"name":"3x Packs (90 Patches) -  Slim Patch","id":1753,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Packs (90 Patches) -  Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"4 Month Supply (120 Patches) -  Slim Patch","id":1758,"quantity":1,"price":0,"shippable":false,"fullPrice":59.96,"finalPrice":59.96,"productName":"4 Month Supply (120 Patches) -  Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"4x Akemi Detox Tea","id":1763,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"4x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"name":"4x Packs (120 Patches) - Slim Patch","id":1754,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"4x Packs (120 Patches) - Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"Akemi Slim Patch  Journey Package Protection","id":1760,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Akemi Slim Patch  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Akemi Slim Patch - 3 Year Warranty","id":1759,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Akemi Slim Patch - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA 1 Month Supply (30 Patches) - Slim Patch","id":1761,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA 1 Month Supply (30 Patches) - Slim Patch","discountAmount":0,"discountPercentage":0},{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":14.99,"shippable":false,"fullPrice":14.99,"finalPrice":14.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0}]
};
...
const shippables = [{"id":1698,"name":"Akemi Detox Tea"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"},{"id":1750,"name":"Slim Patch"}];
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "8AuBSTRNLYxBNnBOkDqRARCKKRHVSocoarljhHqpsYdu4vjFwRo9UxqOl6ZST7M5",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/698f8f3a5dfb37cbef9143e2-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "ASP-Checkout-V1", pageType: "Checkout" },
    };
